...
# Set up the bot
TOKEN = os.getenv('7233846991:AAEy0fp_d4zzTVQfD0MflnYwTgU9Cq5f5KM')
...
if __name__ == '__main__':
    # Set the port to the one provided by Render or default to 5000
    port = int(os.getenv('PORT', 5000))
    # Start Flask app with webhook enabled
